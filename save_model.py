...
flags.DEFINE_integer('channels', 3, 'define number of channels used in the model')
...
def save_tf():
  ...
  input_layer = tf.keras.layers.Input([FLAGS.input_size, FLAGS.input_size, FLAGS.channels])
